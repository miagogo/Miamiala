...
dgClear: function()
{
	if($(this).data("checked") == true)
	{
		...
		$(this).parent().parent().parent().parent().parent().parent().parent().addClass('chosenBox');
		}
	else
	{
...
dgCheck: function(div)
{
	...
	$(div).data('checked',true).css({backgroundPosition:"left bottom"});
},
dgUncheck: function(div)
{
	$(this).attr("checked",false);
	if(div != -1)
		$(div).data('checked',false).css({backgroundPosition:"left 1px"});
	else
		$(this).parent().data("checked",false).css({backgroundPosition:"left 1px"});
}
});